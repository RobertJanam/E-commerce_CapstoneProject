...
<head>
    ...
    <title>Admin Registration - Sports Gear Shop</title>
...
<div class="register-card">
    ...
    <form id="regForm" action="auth/admin_register-process.php" method="POST">
        ...
        <button type="submit" name="admin_register">Submit</button>
    </form>
